...
class PaymentNotificationsControllerTest < ActionController::TestCase
  ...
  test "should create payment_notification" do
    assert_difference('PaymentNotification.count') do
      post :create, payment_notification: { create: @payment_notification.create, first_name: @payment_notification.first_name, params: @payment_notification.params, payer_email: @payment_notification.payer_email, transaction_id: @payment_notification.transaction_id }
    end
  ...
  test "should update payment_notification" do
    patch :update, id: @payment_notification, payment_notification: { create: @payment_notification.create, first_name: @payment_notification.first_name, params: @payment_notification.params, payer_email: @payment_notification.payer_email, transaction_id: @payment_notification.transaction_id }
    assert_redirected_to payment_notification_path(assigns(:payment_notification))
  end
